...
public class WXLogUtils {
  private static final String APP_TAG = "ddjf_interview_log";
...
//      writeConsoleLog("debug", builder.substring(0));
  ...
  private static void log(String tag, String msg, LogLevel level){
    if(msg != null && tag != null && sLogWatcher !=null){
      sLogWatcher.onLog(level.getName(), APP_TAG,"tag="+tag+"  msg="+ msg);
    }

    if (WXEnvironment.isApkDebugable()) {
      Log.println(level.getPriority(),APP_TAG,"tag="+tag+"  msg="+ msg);
