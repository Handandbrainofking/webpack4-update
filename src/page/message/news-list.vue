...
export default {
  ...
  created() {
    let tabInitIndex =  this.getPageParams('type') || 0
  ...
  methods: {
    loadPageData() {
      ...
      this.params = Object.assign(this.params, params, {msgType: 'NORMAL'})
