        ...
        <div class="dd-picker-body" :style="pickerBodyStyle">
            ...
            <div class="content">
                <scroller ref="scroller" :style="scrollerStyle">
                    <div class="options">
                        <div class="option" v-for="option in displayOptions" :style="isCurrent(option) && selectedStyle" @click="selectOption(option)" :key="option[keyProp]||option[displayProp]">
            ...
            <div class="footer">
                ...
                <text class="footer-commit" @click="$emit('commit', currentItem ? currentItem.name:value, currentItem[keyProp], currentItem)">确定</text>
            </div>
        </div>
    </div>
</template>
